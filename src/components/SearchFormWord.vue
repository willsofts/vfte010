<template>
<div id="searchpanelword" class="panel-body search-panel">
    <div class="row row-height">
        <div class="col-height col-md-3">
            <label>{{ labels.reservepwds_label }}</label>
            <input type="text" v-model="localData.reservepwd" class="form-control input-md" maxlength="50" />
        </div>
...
const tableSettings = {
    ...
    columns: [
        {name: "reservepwd", type: "STRING", sorter: "reservepwd", label: "reservepwd_headerlabel" },
    ],        
    actions: [
