<template>
    <DialogForm ref="dialogForm">
      ...
      <template v-slot:footer>
        <button ref="savebuttonnum" id="savebuttonnum" class="btn btn-dark btn-sm" @click="saveClick" v-if="insertMode"><em class="fa fa-save fa-btn-icon"></em>{{ labels.save_button }}</button>
        <button ref="updatebuttonnum" id="updatebuttonnum" class="btn btn-dark btn-sm" @click="updateClick" v-if="updateMode"><em class="fa fa-save fa-btn-icon"></em>{{ labels.update_button }}</button>
        <button id="canceldialogbuttonnum" class="btn btn-dark btn-sm" data-dismiss="modal"><em class="fa fa-close fa-btn-icon"></em>{{ labels.cancel_button }}</button>
      </template>
    </DialogForm>
  </template>
  <script>
  ...
  export default {
    ...
    methods: {
      ...
      saveRecord(dataRecord) {
          ...
          startWaiting();
          $.ajax({
            url: getApiUrl()+APP_URL+"/insertnum",
      ...
      updateRecord(dataRecord) {
          ...
          startWaiting();
          $.ajax({
            url: getApiUrl()+APP_URL+"/updatenum",
            data: formdata.jsondata,
            headers : formdata.headers,
            type: "POST",
            dataType: "json",
      ...
      retrieveRecord(dataKeys) {
        ...
        startWaiting();
        $.ajax({
          url: getApiUrl()+APP_URL+"/retrievenum",
          data: formdata.jsondata,
          headers : formdata.headers,
          type: "POST",
          dataType: "json",
      ...
      deleteRecord(dataKeys) {
        ...
        startWaiting();
        $.ajax({
          url: getApiUrl()+APP_URL+"/removenum",
          data: formdata.jsondata,
          headers : formdata.headers,
          type: "POST",
          dataType: "json",
